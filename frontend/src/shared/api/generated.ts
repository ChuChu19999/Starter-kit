export namespace Schemas {
  // <Schemas>
  export type EmployeesByHashesRequest = {
    hashesMd5: Array<string>;
    includePhoto?: (boolean | null) | undefined;
  };
...
export namespace Endpoints {
  ...
  export type get_Get_current_user_info_api_me__get = {
    method: 'GET';
    path: '/api/me/';
    requestFormat: 'json';
    parameters: never;
    responses: { 200: Schemas.UserResponse; 401: unknown };
  };
  export type get_Search_employees_api_employees_search__get = {
    method: 'GET';
    path: '/api/employees/search/';
    requestFormat: 'json';
    parameters: {
      query: { searchFio: string; includePhoto?: boolean | undefined };
    };
    responses: { 200: unknown; 400: unknown; 422: Schemas.HTTPValidationError; 503: unknown };
  };
  export type get_Get_employee_api_employees__hash_md5___get = {
    method: 'GET';
    path: '/api/employees/{hash_md5}/';
    requestFormat: 'json';
    parameters: {
      query: Partial<{ includePhoto: boolean }>;
      path: { hash_md5: string };
    };
    responses: {
      200: unknown;
      400: unknown;
  ...
  export type post_Get_employees_by_hashes_endpoint_api_employees_by_hashes__post = {
    method: 'POST';
    path: '/api/employees/by-hashes/';
    requestFormat: 'json';
    parameters: {
      body: Schemas.EmployeesByHashesRequest;
    };
    responses: { 200: unknown; 422: Schemas.HTTPValidationError; 503: unknown };
  };
  export type get_Root_api__get = {
    method: 'GET';
    path: '/api/';
    requestFormat: 'json';
    parameters: never;
  ...
  export type get_Health_api_health__get = {
    method: 'GET';
    path: '/api/health/';
    requestFormat: 'json';
    parameters: never;
...
export type EndpointByMethod = {
  get: {
    '/api/me/': Endpoints.get_Get_current_user_info_api_me__get;
    '/api/employees/search/': Endpoints.get_Search_employees_api_employees_search__get;
    '/api/employees/{hash_md5}/': Endpoints.get_Get_employee_api_employees__hash_md5___get;
    '/api/': Endpoints.get_Root_api__get;
    '/api/health/': Endpoints.get_Health_api_health__get;
  };
  post: {
    '/api/employees/by-hashes/': Endpoints.post_Get_employees_by_hashes_endpoint_api_employees_by_hashes__post;
  };
};
